...
const HamburgerBtn = styled.button<IClicked>
`
  display: none;
  @media only Screen and (max-width: 48em) {
...
const MobileMenu = styled.nav<IClicked>
`
  display: none;
  @media only Screen and (max-width: 48em) {
    display: flex;
...
const Header = () => {
  ...
  const logo = require("../../assets/landing/logo-grey-bg.svg").default
  ...
  return (
    <Headers ref={ref}>
      ...
      <Nav>
        ...
        <a href="#about" onClick={(e) => {navigate('/');scrollUp("about", e)}}>
          About Us
        </a>
        {/* <a href="#services" onClick={(e) => {navigate('/');scrollUp("services", e)}}>
          Services
        </a> */}
        <a href="#contact" onClick={(e) => {navigate('/');scrollUp("contact", e)}}>
          Contact Us
        </a>
